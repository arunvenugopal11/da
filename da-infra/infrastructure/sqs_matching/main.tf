# Match engine events (likes, passes, daily recs)
...
resource "aws_ssm_parameter" "queue_url" {
  name  = "/${var.env_name}/infrastructure/sqs/matching-queue-url"
  type  = "String"
  value = aws_sqs_queue.main.url
}

resource "aws_ssm_parameter" "queue_arn" {
  name  = "/${var.env_name}/infrastructure/sqs/matching-queue-arn"
  type  = "String"
  value = aws_sqs_queue.main.arn
}

resource "aws_ssm_parameter" "dlq_url" {
  name  = "/${var.env_name}/infrastructure/sqs/matching-dlq-url"
  type  = "String"
